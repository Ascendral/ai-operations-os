...
describe("AdaptiveSafetyGate", () => {
  ...
  describe("evaluateAction", () => {
    it("applies weight multiplier to CORD score", () => {
      ...
      const gate = new AdaptiveSafetyGate(
        mockCordGate as any,
        new WeightManager(store),
      );
    ...
    it("caps adjusted score at 99", () => {
      ...
      const result = gate.evaluateAction("shopify", "refund", {
        orderId: "o-1",
      });
