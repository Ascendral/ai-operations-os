...
describe("ApprovalSchema", () => {
  it("has $schema set to draft-07", () => {
    expect(ApprovalSchema.$schema).toBe(
...
describe("ActionReceiptSchema", () => {
  it("has $schema set to draft-07", () => {
    expect(ActionReceiptSchema.$schema).toBe(
      "http://json-schema.org/draft-07/schema#",
    );
  });

  it("has correct $id", () => {
    expect(ActionReceiptSchema.$id).toBe(
      "https://ai-ops.dev/schemas/action-receipt.json",
    );
  });
  ...
  it("cordReasons is an array of strings", () => {
    ...
    expect(ActionReceiptSchema.properties.cordReasons.items).toEqual({
      type: "string",
    });
  });
...
describe("WorkflowStepSchema", () => {
  it("has $schema set to draft-07", () => {
    expect(WorkflowStepSchema.$schema).toBe(
      "http://json-schema.org/draft-07/schema#",
    );
  });

  it("has correct $id", () => {
    expect(WorkflowStepSchema.$id).toBe(
      "https://ai-ops.dev/schemas/workflow-step.json",
    );
  });
...
describe("WorkflowRunSchema", () => {
  it("has $schema set to draft-07", () => {
    expect(WorkflowRunSchema.$schema).toBe(
      "http://json-schema.org/draft-07/schema#",
    );
  });

  it("has correct $id", () => {
    expect(WorkflowRunSchema.$id).toBe(
      "https://ai-ops.dev/schemas/workflow-run.json",
    );
  });
