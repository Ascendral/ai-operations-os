  ...
  try {
    ...
    const taskDefs: Array<Parameters<typeof createTask>[0]> = [
      ...
      },
      {
        ...
        body: "My order arrived with a cracked screen. I need a replacement or refund ASAP.",
        intent: "escalate",
        priority: "urgent",
        status: "running",
      },
      {
        ...
        body: "We are interested in exploring a strategic partnership. Could we schedule a call next week?",
        intent: "reply",
        priority: "normal",
        status: "pending",
      },
      {
        ...
        body: "Attached is the draft for this week's newsletter. Please approve or suggest edits.",
        intent: "reply",
        priority: "low",
      ...
      },
      {
        ...
        body: "Block 2 hours next Thursday for the quarterly product roadmap review.",
        intent: "schedule",
        priority: "high",
        status: "planned",
      },
      {
        ...
        body: "The investor call needs to move to Friday 2pm EST.",
        intent: "schedule",
        priority: "urgent",
        status: "pending",
      },
      {
        ...
        body: "Create a recurring daily standup at 9:15am for platform engineering.",
        intent: "schedule",
        priority: "normal",
        status: "completed",
      },
      {
        ...
        body: "The old sprint planning meeting on Mondays is no longer needed.",
        intent: "schedule",
        priority: "low",
        status: "completed",
      },
      {
        ...
        body: "A tech influencer with 500k followers posted about our product. Draft a thank-you reply.",
        intent: "post",
        priority: "urgent",
        status: "running",
      },
      {
        ...
        body: "Prepare and schedule the v2.0 launch announcement across X and LinkedIn.",
        intent: "post",
        priority: "high",
        status: "awaiting_approval",
      },
      {
        ...
        body: "Track and summarize all brand mentions across social platforms.",
        intent: "ignore",
        priority: "normal",
        status: "planned",
      },
      {
        ...
        body: "User @janedoe asked about our refund policy. Draft a helpful reply.",
        intent: "reply",
        priority: "normal",
        status: "pending",
      },
      {
        ...
        body: "Customer requested a full refund. Item was returned in original packaging.",
        intent: "refund",
        priority: "high",
        status: "awaiting_approval",
      },
      {
        ...
        body: "150 units of SKU-7721 need to be shipped by end of week.",
        intent: "fulfill",
        priority: "urgent",
        status: "running",
      },
      {
        ...
        body: "Warehouse confirmed receipt of 500 units each for SKU-3301 through SKU-3303.",
        intent: "fulfill",
        priority: "normal",
        status: "completed",
      },
      {
        ...
        body: "Payment gateway returned error code E-4422.",
        intent: "escalate",
        priority: "high",
        status: "failed",
      },
      {
        ...
        body: "Review the allow/challenge/block boundaries and propose adjustments.",
        intent: "unknown",
        priority: "normal",
        status: "pending",
      },
      {
        ...
        body: "Run a full verification of the receipt chain for last month.",
        intent: "unknown",
        priority: "low",
        status: "planned",
      },
      {
        ...
        body: "Implement and test the Slack connector module.",
        intent: "unknown",
        priority: "high",
        status: "running",
      },
      {
        ...
        body: "Compile all approval decisions and receipt chain summaries.",
        intent: "unknown",
        priority: "normal",
        status: "pending",
      },
    ...
    const wf3 = createWorkflowRun(tasks[12].id, "store-refund", [
      ...
      createStep("shopify", "issue_refund", {
        orderId: "12045",
        amount: 89.99,
      }),
    ]);
    ...
    > = [
      ...
      },
      {
        ...
        cordDecision: "ALLOW",
        cordScore: 18,
        cordReasons: ["classification operation"],
        input: { connector: "codebot", operation: "classify" },
        output: { intent: "reply" },
      ...
      },
      {
        ...
        cordDecision: "ALLOW",
        cordScore: 25,
        cordReasons: ["content generation"],
        input: { connector: "codebot", operation: "draft_reply" },
        output: { draftLength: 245 },
      ...
      },
      {
        ...
        cordScore: 52,
        cordReasons: ["outbound email", "approved by user"],
        input: { connector: "gmail", operation: "send" },
        output: { sent: true },
      ...
      },
      {
        ...
        cordDecision: "ALLOW",
        cordScore: 8,
        cordReasons: ["read-only", "internal audit"],
        input: { connector: "system", operation: "log_completion" },
        output: { logged: true },
